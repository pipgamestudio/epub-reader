...
public class Constants {
    ...
    public static final String DICTIONARY_URL = "https://api.pearson.com";
    public static final String DICTIONARY_BASE_URL = DICTIONARY_URL + "/v2/dictionaries/entries?headword=";
