...
import static com.folioreader.Constants.DICTIONARY_URL;
...
//Log.d("dictionary result:", res.toString());
...
//Log.d("translation:", senses.toString());
                if (senses.getTranslation() != null) {
                    for (String s : senses.getTranslation()) {
                        tra.append("\u2022 ").append(s).append('\n');
                    }
                }
            }
        ...
        if (!tra.toString().trim().isEmpty()) {
            tra.insert(0, "Translation\n");
            holder.translation.setText(tra.toString());
        } else {
        ...
        holder.sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("DictionaryAdapter", "clicked");
                if (res.getPronunciations() != null) {
                    final String url = DICTIONARY_URL + getAudioUrl(res.getPronunciations());
    ...
    public static class DictionaryHolder extends RecyclerView.ViewHolder {
        private TextView name, translation, definition, example;
        ...
        public DictionaryHolder(View itemView) {
            ...
            if (config.isNightMode()) {
                ...
                translation.setTextColor(nightTextColor);
